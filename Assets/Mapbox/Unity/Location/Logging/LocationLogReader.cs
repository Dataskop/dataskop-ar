		...
		public IEnumerator<Location> GetLocations() {
			...
			while (true) {
				...
				if (DateTime.TryParseExact(
					    dtDeviceTxt, "yyyyMMdd-HHmmss.fff", _invariantCulture, DateTimeStyles.AssumeUniversal,
					    out dtDevice
				    )) {
				...
				if (DateTime.TryParseExact(
					    dtLocationTxt, "yyyyMMdd-HHmmss.fff", _invariantCulture, DateTimeStyles.AssumeUniversal,
					    out dtLocation
				    )) {
