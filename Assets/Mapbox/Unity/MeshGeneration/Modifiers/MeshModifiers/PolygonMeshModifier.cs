	...
	public class PolygonMeshModifier : MeshGenerationBase {
		...
		public override void Run(VectorFeatureUnity feature, MeshData md, UnityTile tile = null) {
			if (Criteria != null && Criteria.Count > 0) {
				foreach (IReplacementCriteria criterion in Criteria) {
			...
			int _counter = feature.Points.Count;
			List<List<Vector3>> subset = new(_counter);
			Data flatData = null;
			...
			for (int i = 0; i < _counter; i++) {
				...
				Vector2d _size = md.TileRect.Size;
