...
public class TerrainDataFetcher : DataFetcher {
	...
	public override void FetchData(DataFetcherParameters parameters) {
		TerrainDataFetcherParameters terrainDataParameters = parameters as TerrainDataFetcherParameters;
		...
		pngRasterTile.Initialize(
			_fileSource, terrainDataParameters.canonicalTileId, terrainDataParameters.tilesetId, () =>
			{
				...
				if (pngRasterTile.HasError) {
					FetchingError(
						terrainDataParameters.tile, pngRasterTile,
						new TileErrorEventArgs(
							terrainDataParameters.canonicalTileId, pngRasterTile.GetType(), null,
