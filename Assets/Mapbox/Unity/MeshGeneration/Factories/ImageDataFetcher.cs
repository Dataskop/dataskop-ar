...
public class ImageDataFetcher : DataFetcher {
	...
	public override void FetchData(DataFetcherParameters parameters) {
		ImageDataFetcherParameters imageDataParameters = parameters as ImageDataFetcherParameters;
		...
		rasterTile.Initialize(
			_fileSource, imageDataParameters.tile.CanonicalTileId, imageDataParameters.tilesetId, () =>
			{
				...
				if (rasterTile.HasError) {
					FetchingError(
						imageDataParameters.tile, rasterTile,
						new TileErrorEventArgs(
							imageDataParameters.tile.CanonicalTileId, rasterTile.GetType(), imageDataParameters.tile,
