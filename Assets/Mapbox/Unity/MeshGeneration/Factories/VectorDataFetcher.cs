...
public class VectorDataFetcher : DataFetcher {
	...
	public override void FetchData(DataFetcherParameters parameters) {
		VectorDataFetcherParameters vectorDaraParameters = parameters as VectorDataFetcherParameters;
		...
		vectorTile.Initialize(
			_fileSource, vectorDaraParameters.tile.CanonicalTileId, vectorDaraParameters.tilesetId, () =>
			{
				...
				if (vectorTile.HasError) {
					FetchingError(
						vectorDaraParameters.tile, vectorTile,
						new TileErrorEventArgs(
							vectorDaraParameters.tile.CanonicalTileId, vectorTile.GetType(), vectorDaraParameters.tile,
