namespace Mapbox.Editor {
	...
	public class LineGeometryOptionsDrawer : PropertyDrawer {
		...
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
			...
			property.FindPropertyRelative("JoinType").enumValueIndex = (int)(LineJoinType)EditorGUILayout.EnumPopup(
				"Join Type", (LineJoinType)property.FindPropertyRelative("JoinType").intValue
			);
			...
			property.FindPropertyRelative("CapType").enumValueIndex = (int)(LineCapType)EditorGUILayout.EnumPopup(
				"Cap Type", (LineCapType)property.FindPropertyRelative("CapType").intValue
			);
