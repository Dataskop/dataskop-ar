namespace Mapbox.Editor {
	...
	public class BehaviorModifiersSectionDrawer {
			...
			if (showGameplay) {
				...
				if (layerProperty.FindPropertyRelative("honorBuildingIdSetting").boolValue == true) {
					...
					EditorGUILayout.PropertyField(
						layerProperty.FindPropertyRelative("buildingsWithUniqueIds"), new GUIContent {
				...
				SerializedProperty combineMeshesProperty = subLayerCoreOptions.FindPropertyRelative("combineMeshes");
				...
				if (combineMeshesProperty.boolValue == false) {
					...
					featurePositionProperty.enumValueIndex = EditorGUILayout.Popup(
						dropDownLabel, featurePositionProperty.enumValueIndex, dropDownItems
					);
		...
		private void DrawMeshModifiers(SerializedProperty property) {
			...
			SerializedProperty meshfac = property.FindPropertyRelative("MeshModifiers");
