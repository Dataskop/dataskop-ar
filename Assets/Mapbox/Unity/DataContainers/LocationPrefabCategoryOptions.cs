namespace Mapbox.Unity.Map {
	...
	public static class LocationPrefabCategoryOptions {
		...
		private static Dictionary<LocationPrefabCategories, List<string>> CategoriesToMakiDictionary = new() {
			{
				LocationPrefabCategories.ArtsAndEntertainment, new List<string> {
					"art-gallery",
					"cinema",
					"stadium",
					"museum",
				...
				LocationPrefabCategories.Nightlife, new List<string> {
					"bar",
					"beer"
				}
			}, {
				LocationPrefabCategories.OutdoorsAndRecreation, new List<string> {
					"aquarium",
					"campsite",
					"attraction",
					"castle",
				...
				LocationPrefabCategories.Shops, new List<string> {
					"alcohol-shop",
					"clothing-store",
					"shop"
				}
