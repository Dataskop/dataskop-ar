...
namespace Mapbox.MapboxSdkCs.UnitTest {
	...
	internal class Vector2dBoundsTest {
		...
		public void SmallBounds() {
			...
			Vector2dBounds bounds = new Vector2dBounds(a, b);
		...
		[Test]
		public void Extend() {
			Vector2dBounds bounds1 = new Vector2dBounds(new Vector2d(-10, -10), new Vector2d(10, 10));
			Vector2dBounds bounds2 = new Vector2dBounds(new Vector2d(-20, -20), new Vector2d(20, 20));
		...
		public void CardinalLimits() {
			Vector2dBounds bounds = new Vector2dBounds(new Vector2d(10, 20), new Vector2d(30, 40));
		...
		[Test]
		public void IsEmpty() {
			Vector2dBounds bounds1 = new Vector2dBounds(new Vector2d(10, 10), new Vector2d(0, 0));
			Assert.IsTrue(bounds1.IsEmpty());

			Vector2dBounds bounds2 = new Vector2dBounds(new Vector2d(0, 0), new Vector2d(0, 0));
			Assert.IsFalse(bounds2.IsEmpty());

			Vector2dBounds bounds3 = new Vector2dBounds(new Vector2d(0, 0), new Vector2d(10, 10));
		...
		[Test]
		public void Center() {
			Vector2dBounds bounds1 = new Vector2dBounds(new Vector2d(0, 0), new Vector2d(0, 0));
			...
			Vector2dBounds bounds2 = new Vector2dBounds(new Vector2d(-10, -10), new Vector2d(10, 10));
			...
			Vector2dBounds bounds3 = new Vector2dBounds(new Vector2d(0, 0), new Vector2d(20, 40));
