	...
	public static class LogEntries {
		...
		static LogEntries() {
			...
			if (_type == null) {
				...
				_GetFirstTwoLinesEntryTextAndModeInternal = _type.GetMethod(
					"GetFirstTwoLinesEntryTextAndModeInternal", flags
				);
		...
		public static void GetCountsByType(ref int errorCount, ref int warningCount, ref int logCount) {
			_GetCountsByType.Invoke(
				null, new object[3] {
					errorCount, warningCount, logCount
				}
			);
		}

		public static void GetFirstTwoLinesEntryTextAndModeInternal(int row, ref int mask, ref string outString) {
			_GetFirstTwoLinesEntryTextAndModeInternal.Invoke(
				null, new object[3] {
					row, mask, outString
				}
			);
		...
		public static bool GetEntryInternal(int row, object outputEntry) {
			return (bool)_GetEntryInternal.Invoke(
				null, new object[2] {
					row, outputEntry
				}
			);
		...
		public static int GetEntryCount(int row) {
			return (int)_GetEntryCount.Invoke(
				null, new object[1] {
					row
				}
			);
